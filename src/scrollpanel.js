...
Rustica.UI.Pane = function (game, x, y, width, height, backgroundImg) {
    ...
    if (backgroundImg) {
        this.changeBackground(backgroundImg);
    }
...
Rustica.UI.Pane.prototype.move = function (newX, newY) {
    this.x = newX;
    this.y = newY;
};

Rustica.UI.Pane.prototype.resize = function (width, height) {
    this.w = width;
    this.h = height;
...
Rustica.UI.Pane.prototype.changeBackground = function (backgroundImg) {
    if (this.background)
...
Rustica.UI.Scrollpane = function (game, x, y, width, height, backgroundImg, maskImg) {
...
Rustica.UI.Scrollpane.prototype = Object.create(Rustica.UI.Pane.prototype);
